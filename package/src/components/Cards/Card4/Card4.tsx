...
const Card4: React.FC<CardProps> = ({ image, name, designation, message }) => {
      ...
      <div className="relative z-10 p-6">
        <div className="flex flex-col items-center justify-center mb-4">
          ...
          <div className="ml-4 text-center mt-5">
            <h3 className="text-lg font-semibold text-[#f4e8c1]">{name}</h3>
            <p className="text-sm text-[#d9d6cf]">{designation}</p>
          </div>
        </div>
